...
ServerMessageParser::ServerMessageParser(char* sendBuf, char* recvBuf, sockaddr_in *remoteaddr){
...
stUserInfo* ServerMessageParser::getUserByName(const char *userName)
{
	UserList_Iter it;
	for( it = clientList.begin(); it != clientList.end(); it++ )
	{
...
stUserInfo* ServerMessageParser::getUserByIP(const unsigned int& userIP)
{
	UserList_Iter it;
	for( it = clientList.begin(); it != clientList.end(); it++ )
	{
